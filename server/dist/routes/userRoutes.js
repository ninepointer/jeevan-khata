...
router.route('/familyMember').get(authController_1.protect, userController_1.getFamilyMember);
router.route('/familyMemberDocuments/:id').get(authController_1.protect, userController_1.getFamilyMemberDocuments);
router.route('/familyTree').post(authController_1.protect, userController_1.createFamilyMember);
